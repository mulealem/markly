...
<template>
  <DialogRoot>
    <DialogTrigger
      class="text-grass11 font-semibold shadow-blackA7 hover:bg-mauve3 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-white px-[15px] leading-none -[0_2px_10px] focus:shadow-[0_0_0_2px] focus:-black focus:outline-none"
    >
      Edit profile
    </DialogTrigger>
    <DialogPortal>
